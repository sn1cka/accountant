...
import 'package:money_accountant/src/core/rest_client/src/http/check_exception_io.dart'
    if (dart.library.js_interop) 'package:money_accountant/src/core/rest_client/src/http/check_exception_browser.dart';
